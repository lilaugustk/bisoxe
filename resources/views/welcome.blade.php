                                        ...
                                        <tbody class="divide-y divide-gray-100">
                                            @foreach ($filteredPlates as $index => $plate)
                                                <tr class="transition duration-150 hover:bg-gray-50/50">
                                                    ...
                                                    <td
                                                        class="px-3 py-1.5 text-sm font-bold whitespace-nowrap {{ $plate['color'] === 1 ? 'text-amber-600' : 'text-gray-700' }}">
                                                        {{ $plate['display_number'] }}
                                                    </td>
                                                    <td
                                                        class="px-3 py-1.5 text-sm text-gray-750 whitespace-nowrap font-bold text-[#8C1E1E]">
