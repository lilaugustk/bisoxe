...
<div class="min-h-screen bg-[#F9FAFB] font-sans text-[#111827] antialiased" x-data="{
...
}" x-init="generateToc(); initPendingPoll();">
    ...
    <main class="mx-auto max-w-[1440px] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            ...
            <div class="group relative flex min-h-[300px] flex-col items-center justify-between overflow-hidden rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6 lg:col-span-7">
                ...
                <div class="relative z-10 mb-4 flex gap-2">
                    @if(count($plate['kinds']) > 0)
                        <span class="inline-flex items-center gap-1 rounded-md bg-[#8C1E1E]/5 px-2.5 py-1 text-xs font-extrabold uppercase tracking-wide text-[#8C1E1E] ring-1 ring-[#8C1E1E]/10">
                            {{ $plate['kinds'][0]['name'] }}
                        </span>
                    @else
                        <span class="inline-flex items-center gap-1 rounded-md bg-gray-50 px-2.5 py-1 text-xs font-extrabold uppercase tracking-wide text-gray-600 ring-1 ring-gray-200">
                ...
                <div class="relative z-10 flex w-full items-center justify-center py-4">
                    <div class="perspective-1000 w-full flex justify-center">
                        <div class="transform transition-all duration-500 hover:rotate-x-6 hover:rotate-y-6 w-full flex justify-center">
                            <!-- 1. Long Plate Style (Biển dài tiêu chuẩn 1 dòng) -->
                            <div
                                x-show="plateStyle === 'long'"
                            ...
                            >
                                <!-- Acrylic shine layer -->
                                <div class="pointer-events-none absolute inset-0 rounded bg-gradient-to-tr from-transparent via-white/10 to-transparent"></div>

                                <!-- Embossed inner border line -->
                                <div class="flex h-full w-full items-center justify-center rounded border px-3 min-[340px]:px-4 min-[380px]:px-6 sm:px-8 select-none {{ $plate['color'] === 1 ? 'border-black/35' : 'border-gray-300' }}">
                                    <!-- Long Plate Text (Single Line) -->
                                    <div class="flex items-center justify-center text-center font-sans font-black tracking-tight">
                                        <span class="text-[1.4rem] min-[340px]:text-[1.8rem] min-[380px]:text-[2.2rem] min-[440px]:text-[2.6rem] md:text-[3rem] leading-none font-black text-black uppercase select-none">
                                            {{ $plate['local_symbol'] }}{{ $plate['serial_letter'] }}
                                        </span>
                                        <span class="mx-1 min-[340px]:mx-1.5 min-[380px]:mx-2.5 md:mx-3.5 text-[1.2rem] min-[340px]:text-[1.6rem] min-[380px]:text-[2rem] min-[440px]:text-[2.4rem] md:text-[2.8rem] leading-none font-bold text-black/80">-</span>
                                        <span class="flex items-center text-[1.4rem] min-[340px]:text-[1.8rem] min-[380px]:text-[2.2rem] min-[440px]:text-[2.6rem] md:text-[3rem] leading-none font-black text-black select-none">
                            ...
                            >
                                <!-- Acrylic shine layer -->
                                <div class="pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-tr from-transparent via-white/10 to-transparent"></div>

                                <!-- Embossed inner border line -->
                                <div class="flex h-full w-full flex-col items-center justify-center gap-y-1 min-[360px]:gap-y-2 rounded border px-3 py-2.5 min-[360px]:px-4 min-[360px]:py-4 md:px-6 md:py-6 select-none {{ $plate['color'] === 1 ? 'border-black/35' : 'border-gray-300' }}">
                                    <!-- Row 1: Mã vùng + Seri -->
                                    <div class="w-full text-center font-sans text-[1.4rem] min-[340px]:text-[1.6rem] min-[360px]:text-[1.8rem] min-[400px]:text-[2.2rem] md:text-[3.1rem] leading-none font-black uppercase">
                                        {{ $plate['local_symbol'] }}{{ $plate['serial_letter'] }}
                                    </div>
                                    <!-- Row 2: Dãy 5 số -->
                                    <div class="flex w-full items-end justify-center text-center font-sans text-[1.4rem] min-[340px]:text-[1.6rem] min-[360px]:text-[1.8rem] min-[400px]:text-[2.2rem] md:text-[3.1rem] leading-none font-black">
                ...
                <div class="relative z-10 mt-4 flex w-full flex-col items-center gap-3">
                    ...
                    <div class="flex w-full max-w-[285px] rounded-xl border border-gray-200 bg-gray-100 p-1 shadow-inner">
                        <button
                            type="button"
                            ...
                            :class="plateStyle === 'long' ? 'bg-white text-[#8C1E1E] shadow-sm font-black' : 'text-gray-500 hover:text-gray-900'"
                        >
                            Bản biển dài
                        </button>
                        <button
                            ...
                            class="w-1/2 rounded-lg py-1.5 px-3 text-xs font-extrabold transition-all duration-300 select-none cursor-pointer"
                            :class="plateStyle === 'square' ? 'bg-white text-[#8C1E1E] shadow-sm font-black' : 'text-gray-500 hover:text-gray-900'"
                        >
                            Bản biển vuông
                        </button>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-xs text-gray-500">
                            Vùng đăng ký:
                            <strong class="text-gray-900">{{ $plate['province'] ? $plate['province']['name'] : 'Chưa rõ' }}</strong>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-5 flex flex-col justify-between">
                <div class="space-y-4 divide-y divide-gray-100 flex-1">
                    ...
                    <div class="flex items-center justify-between pb-3.5">
                        ...
                        <div class="text-right">
                            ...
                            @if($valuationComparison)
                                <span class="block text-[10px] sm:text-[11px] font-bold {{ $valuationComparison['colorClass'] === 'border-green-200 bg-green-50 text-green-700' ? 'text-green-700' : ($valuationComparison['colorClass'] === 'border-red-200 bg-red-50 text-red-700' ? 'text-red-700' : 'text-gray-900') }}">
                    ...
                    <div class="flex items-center justify-between pt-3.5 pb-3.5">
                        ...
                        <span class="text-xs sm:text-sm font-bold text-gray-950 whitespace-nowrap">{{ $statusLabel }}</span>
                    </div>

                    <!-- Row 3: Định giá đề xuất -->
                    <div class="flex items-center justify-between pt-3.5 pb-3.5">
                        <button @click="showPriceGuide = true" type="button" class="flex items-center gap-1 text-xs sm:text-sm font-semibold text-gray-900 hover:text-[#8C1E1E] hover:underline cursor-pointer whitespace-nowrap text-left group">
                            <span>Định giá đề xuất</span>
                            <svg class="w-3.5 h-3.5 text-[#8C1E1E] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-between pt-3.5 pb-3.5">
                        <button @click="showScoringGuide = true" type="button" class="flex items-center gap-1 text-xs sm:text-sm font-semibold text-gray-900 hover:text-[#8C1E1E] hover:underline cursor-pointer whitespace-nowrap text-left group">
                            <span>Điểm</span>
                            <svg class="w-3.5 h-3.5 text-[#8C1E1E] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </button>
                        <span class="text-sm sm:text-base font-black whitespace-nowrap" style="color: {{ $scoreColor }}">
                            {{ $plate_score['score'] }}
                        </span>
                    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6 lg:p-8">
                <header class="mb-6 flex flex-col items-center justify-between gap-4 border-b border-gray-100 pb-5 sm:flex-row">
                    <div class="text-center sm:text-left">
                        ...
                        <p class="text-[11px] sm:text-xs text-gray-500 mt-0.5">
                            Thống kê lịch sử trúng đấu giá của sê-ri đuôi số tương ứng tại <span class="font-bold text-gray-800" x-text="getSelectedProvinceName()"></span>
                        </p>
                    </div>
                </header>
                ...
                <div class="grid grid-cols-1 items-start gap-8 md:grid-cols-3">
                    <div class="md:col-span-3">
                        ...
                        <div class="block lg:hidden mb-6">
                            <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                                ...
                                <div class="max-h-[320px] overflow-y-auto divide-y divide-gray-100 pr-1 scrollbar-none">
                                    <template x-for="(item, i) in getSelectedPlates().slice().reverse()" :key="'mobile-plate-' + i">
                                        <div class="flex items-center justify-between py-3">
                                            <div class="flex flex-col gap-1 min-w-0">
                                                <span class="inline-flex items-center justify-center rounded border border-gray-300 bg-white px-2 py-0.5 font-sans text-xs font-black tracking-tight text-gray-900 select-none shadow-sm w-max" x-text="item.plate_number"></span>
                                                <span class="text-[10px] font-bold text-gray-500 truncate max-w-[130px] pl-0.5" x-text="item.province_name"></span>
                                            </div>
                                            <div class="flex flex-col items-end gap-0.5 shrink-0 pl-3">
                                                <span class="text-[13px] font-black text-[#8C1E1E] whitespace-nowrap" x-text="formatMoney(item.winning_price)"></span>
                                                <span class="text-[9px] font-medium text-gray-400" x-text="item.auction_date"></span>
                                            </div>
                                        </div>
                                    </template>
                                </div>
                        ...
                        <div class="hidden lg:block border-gray-200 relative overflow-hidden rounded-2xl border bg-gray-50 p-4 shadow-inner md:p-6">
                            <svg viewBox="0 0 500 216" class="h-auto w-full overflow-visible" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                ...
                                <text x="30" y="33" class="text-right font-sans text-[8.5px] md:text-[6px] font-bold md:font-semibold text-gray-400" text-anchor="end" x-text="formatShortMoney(getMaxCategoryValue())"></text>

                                <line x1="35" y1="80" x2="460" y2="80" stroke="#E5E7EB" stroke-width="0.8" stroke-dasharray="3,3" />
                                <text x="30" y="83" class="text-right font-sans text-[8.5px] md:text-[6px] font-bold md:font-semibold text-gray-400" text-anchor="end" x-text="formatShortMoney(getMaxCategoryValue() * 2 / 3)"></text>

                                <line x1="35" y1="130" x2="460" y2="130" stroke="#E5E7EB" stroke-width="0.8" stroke-dasharray="3,3" />
                                <text x="30" y="133" class="text-right font-sans text-[8.5px] md:text-[6px] font-bold md:font-semibold text-gray-400" text-anchor="end" x-text="formatShortMoney(getMaxCategoryValue() * 1 / 3)"></text>

                                <!-- X Axis Line -->
                                <line x1="35" y1="180" x2="460" y2="180" stroke="#D1D5DB" stroke-width="1" />
                                <text x="30" y="183" class="text-right font-sans text-[8.5px] md:text-[6px] font-bold md:font-semibold text-gray-400" text-anchor="end">0</text>

                                <!-- Area Fill (Selected Province) -->
                                <path x-show="getSelectedPlates().length > 0" :d="getAreaPath()" fill="url(#currentAreaGrad)" />

                                <!-- Curve Line (Selected Province) -->
                                <path x-show="getSelectedPlates().length > 0" :d="getLinePath()" fill="none" stroke="#8C1E1E" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />

                                <!-- Highlight hovered vertical guide line -->
                                <line x-show="hoveredIndex !== null" 
                                      :x1="hoveredIndex !== null ? getXCoordinate(hoveredIndex, getSelectedPlates().length) : 0" 
                                      y1="30" 
                                      :x2="hoveredIndex !== null ? getXCoordinate(hoveredIndex, getSelectedPlates().length) : 0" 
                                      y2="180" 
                                      stroke="#D1D5DB" stroke-width="0.8" stroke-dasharray="3,3" />
                            ...
                            <div x-show="hoveredIndex !== null" x-cloak
                                 ...
                                 :style="'left: ' + (hoveredIndex !== null ? getXCoordinate(hoveredIndex, getSelectedPlates().length) / 500 * 100 : 0) + '%; top: 40px; transform: translateX(-50%);'">
                                <div class="min-w-[170px] rounded-lg border border-gray-200/80 bg-white text-[11px] text-gray-800 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.15)]">
                                    <div class="flex items-center gap-1.5 rounded-t-lg border-b border-gray-100 bg-gray-50 px-3 py-1.5">
                                        <span class="h-2 w-2 shrink-0 rounded-full bg-[#8C1E1E]"></span>
                                        <span class="truncate text-[10px] font-bold text-gray-600" x-text="hoveredIndex !== null && getSelectedPlates()[hoveredIndex] ? getSelectedPlates()[hoveredIndex].province_name : ''"></span>
                                    </div>
                        ...
                        <div class="border-gray-200 mt-6 border-t pt-5">
                            <p class="mb-3 text-center text-xs font-bold tracking-wider text-gray-500 uppercase sm:text-left">
                            ...
                            <div class="block sm:hidden mb-4 relative">
                                ...
                                >
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="rounded-full bg-gray-100 px-1.5 py-0.5 text-[9px] font-black text-gray-500" x-text="getSelectedProvinceCountForMobile()"></span>
                                    </div>
                                    <svg class="h-4 w-4 text-gray-455 transition-transform duration-200" :class="isMobileDropdownOpen ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </button>

                                <div x-show="isMobileDropdownOpen" @click.away="isMobileDropdownOpen = false" class="absolute left-0 right-0 mt-1.5 rounded-xl border border-gray-205 bg-white shadow-lg z-50 flex flex-col overflow-hidden">
                                    <div class="p-2 border-b border-gray-100 bg-gray-50/80">
                                        <input x-model="searchMobileProvince" type="text" placeholder="Tìm kiếm tỉnh thành..." class="w-full rounded-lg border border-gray-200 bg-white py-2 pl-3 pr-3 text-xs font-medium focus:border-[#8C1E1E] focus:outline-none" />
                                    </div>
                                    <div class="overflow-y-auto py-1 divide-y divide-gray-50 max-h-56">
                                        <button @click="selectedProvinceCodes = []; isMobileDropdownOpen = false;" type="button" class="w-full flex items-center justify-between px-4 py-2.5 text-left text-xs font-bold transition-colors cursor-pointer" :class="selectedProvinceCodes.length === 0 ? 'bg-[#8C1E1E]/5 text-[#8C1E1E]' : 'text-gray-700 hover:bg-gray-50'">
                                            <span>Tất cả tỉnh thành</span>
                                            <span class="rounded-full px-1.5 py-0.5 text-[9px] font-black" :class="selectedProvinceCodes.length === 0 ? 'bg-[#8C1E1E]/10 text-[#8C1E1E]' : 'bg-gray-100 text-gray-500'" x-text="getTotalPlatesCount()"></span>
                                        </button>
                                        <template x-for="prov in getFilteredProvincesForMobile()" :key="prov.code">
                                            <button @click="selectedProvinceCodes = [prov.code]; isMobileDropdownOpen = false;" type="button" class="w-full flex items-center justify-between px-4 py-2.5 text-left text-xs font-bold transition-colors cursor-pointer" :class="selectedProvinceCodes[0] === prov.code ? 'bg-[#8C1E1E]/5 text-[#8C1E1E]' : 'text-gray-700 hover:bg-gray-50'">
                                                <span x-text="prov.name"></span>
                                                <span class="rounded-full px-1.5 py-0.5 text-[9px] font-black" :class="selectedProvinceCodes[0] === prov.code ? 'bg-[#8C1E1E]/10 text-[#8C1E1E]' : 'bg-gray-100 text-gray-500'" x-text="prov.count"></span>
                                            </button>
                                        </template>
                                    </div>
                                </div>
                            ...
                            <div class="hidden sm:flex flex-wrap gap-2 justify-start">
                                <button
                                    ...
                                    :class="isProvinceActive('all') ? 'border-[#8C1E1E] bg-[#8C1E1E] text-white shadow-sm' : 'border-gray-200 bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900'"
                                >
                                    <span>Tất cả</span>
                                    <span class="rounded-full px-1.5 py-0.5 text-[9px] font-black" :class="isProvinceActive('all') ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-500'" x-text="getTotalPlatesCount()"></span>
                                </button>
                                ...
                                <template x-for="prov in getAvailableProvinces()" :key="prov.code">
                                    <button
                                        ...
                                        class="flex cursor-pointer items-center gap-1.5 rounded-full border px-3.5 py-2 text-xs font-bold transition-all duration-200 select-none shrink-0"
                                        :class="isProvinceActive(prov.code) ? 'border-[#8C1E1E] bg-[#8C1E1E] text-white shadow-sm' : 'border-gray-200 bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900'"
                                    >
                                        <span x-text="prov.name"></span>
                                        <span class="rounded-full px-1.5 py-0.5 text-[9px] font-black" :class="isProvinceActive(prov.code) ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-500'" x-text="prov.count"></span>
                                    </button>
                                </template>
                            </div>
                        </div>
        ...
        @elseif(($plate['status'] ?? '') !== 'custom_valuation')
            ...
            <div class="prose prose-sm sm:prose-base max-w-none prose-headings:font-bold sm:prose-headings:font-extrabold prose-h2:text-base sm:prose-h2:text-xl prose-h3:text-sm sm:prose-h3:text-lg prose-p:text-sm sm:prose-p:text-base prose-p:leading-relaxed text-gray-800">
                <h1 class="mb-4 sm:mb-5 border-b border-gray-100 pb-2 sm:pb-3 font-sans text-[19px] sm:text-2xl lg:text-3xl font-bold sm:font-extrabold tracking-tight text-gray-900 leading-snug sm:leading-tight">
                    {{ $article['title'] }}
                </h1>
                ...
                <div x-show="tocItems.length > 0" class="mb-8 rounded-xl border border-gray-200 bg-gray-50/80 p-4 sm:p-5">
                    <div
        ...
        @if(count($related_plates) > 0)
            <div class="mt-8 border-t border-gray-200 pt-8">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach($related_plates as $relPlate)
                        <div class="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md">
                            <div class="flex items-start justify-between">
                                <div class="flex flex-wrap gap-1.5">
                                    @if(count($relPlate['kinds']) > 0)
                                    ...
                                    @else
                                        <span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-wider text-gray-600 ring-1 ring-gray-200">
                                            Biển thường
                                        </span>
                                    @endif
                                </div>
                                <span class="inline-flex items-center rounded-md bg-[#8C1E1E]/5 px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-wider text-[#8C1E1E] ring-1 ring-[#8C1E1E]/10">
                                    {{ $relPlate['status'] === 'completed' ? 'Đã đấu giá' : ($relPlate['status'] === 'announced' ? 'Đã công bố' : 'Đang chờ') }}
                                </span>
                            </div>

                            <!-- Simulated License Plate Thumbnail -->
                            <div class="my-4 flex justify-center">
                                <div class="relative flex aspect-[520/110] w-full max-w-[220px] items-center justify-center rounded-md border shadow-[0_4px_10px_-1px_rgba(0,0,0,0.1),inset_0_1px_2px_rgba(255,255,255,0.8)] transition-all p-0.5 {{ $relPlate['color'] === 1 ? 'border-2 border-black/80 bg-gradient-to-b from-amber-400 via-amber-400 to-amber-500 text-black' : 'border-2 border-gray-300 bg-gradient-to-b from-white via-white to-gray-50 text-black' }}">
                                    <!-- Acrylic shine layer -->
                                    <div class="pointer-events-none absolute inset-0 rounded bg-gradient-to-tr from-transparent via-white/5 to-transparent"></div>

                                    <!-- Embossed inner border line -->
                                    <div class="flex h-full w-full items-center justify-center rounded border px-3 select-none {{ $relPlate['color'] === 1 ? 'border-black/35' : 'border-gray-300' }}">
                                        <div class="flex items-center justify-center font-sans font-black tracking-tight text-sm uppercase text-black">
                                            ...
                                            <span class="flex items-center">
                                                {{ substr($relPlate['serial_number'], 0, 3) }}.{{ substr($relPlate['serial_number'], 3) }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
    ...
    <div x-show="showScoringGuide" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10" aria-modal="true" role="dialog">
        <!-- Backdrop -->
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm transition-opacity" @click="showScoringGuide = false"></div>
        
        <!-- Modal content container -->
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden transition-all transform scale-100 border border-gray-100 z-10">
            <!-- Close button -->
            <button @click="showScoringGuide = false" type="button" class="absolute top-4 sm:top-5 right-4 sm:right-5 p-2 text-gray-400 hover:text-gray-600 rounded-full hover:bg-gray-100 transition-colors focus:outline-none z-20 cursor-pointer" aria-label="Close modal">
    ...
    <div x-show="showPriceGuide" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10" aria-modal="true" role="dialog">
        <!-- Backdrop -->
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden transition-all transform scale-100 border border-gray-100 z-10">
            <!-- Close button -->
            <button @click="showPriceGuide = false" type="button" class="absolute top-4 sm:top-5 right-4 sm:right-5 p-2 text-gray-900 hover:text-gray-600 rounded-full hover:bg-gray-100 transition-colors focus:outline-none z-20 cursor-pointer" aria-label="Close modal">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
            ...
            <div class="px-5 sm:px-8 py-5 sm:py-6 border-b border-gray-100 flex items-center gap-3">
                <div class="pr-8">
                    ...
                    <p class="text-[11px] sm:text-sm text-gray-900 mt-0.5 font-medium">Cách thức tự động ước lượng giá trị biển số xe</p>
                </div>
            </div>
            ...
            <div class="px-4 sm:px-8 py-5 sm:py-8 overflow-y-auto space-y-6 bg-[#F9FAFB]">
                ...
                <div class="rounded-2xl border border-gray-300 bg-white p-4 sm:p-6 md:p-8 shadow-sm">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-300 pb-3 mb-5">
                    ...
                    <div class="relative pl-7 sm:pl-8 space-y-8 select-none border-l border-dashed border-gray-300 ml-3.5 sm:ml-4">
                        <!-- Step 1: Base Price -->
                        <div class="relative">
                            <span class="absolute -left-7 sm:-left-8 top-0.5 transform -translate-x-1/2 flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-white border-2 border-gray-900 text-[10px] sm:text-xs font-black text-gray-900 shadow-sm">1</span>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pl-3">
                                <div>
                                    ...
                                    <p class="text-[10px] sm:text-xs text-gray-900 mt-0.5">Dựa trên trung bình trúng đấu giá thực tế của nhóm thế số <strong class="text-gray-950 font-bold">{{ $price_prediction['kind_name'] }}</strong> toàn quốc.</p>
                                </div>
                        ...
                        <div class="relative">
                            <span class="absolute -left-7 sm:-left-8 top-0.5 transform -translate-x-1/2 flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-white border-2 border-gray-900 text-[10px] sm:text-xs font-black text-gray-900 shadow-sm">2</span>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pl-3">
                                <div>
                                    <h5 class="text-xs sm:text-sm font-bold text-gray-900">Hệ số điều chỉnh theo khu vực ({{ $plate['province']['name'] ?? 'Tỉnh khác' }})</h5>
                                    <p class="text-[10px] sm:text-xs text-gray-900 mt-0.5">Tính toán tự động dựa trên mức giá đấu trúng thực tế tại khu vực đăng ký so với cả nước.</p>
                                </div>
                                <div class="text-right flex items-center justify-between sm:justify-end gap-3 flex-shrink-0">
                                    ...
                                    <div class="text-[11px] font-bold text-gray-900 whitespace-nowrap">→ {{ $formatMoney($price_prediction['base_price'] * $price_prediction['province_multiplier']) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <span class="absolute -left-7 sm:-left-8 top-0.5 transform -translate-x-1/2 flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-white border-2 border-gray-900 text-[10px] sm:text-xs font-black text-gray-900 shadow-sm">3</span>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pl-3">
                                <div>
                                    <h5 class="text-xs sm:text-sm font-bold text-gray-900">Hệ số tổng nút số ({{ $price_prediction['nut'] }} nút)</h5>
                                    <p class="text-[10px] sm:text-xs text-gray-900 mt-0.5">Hệ số khuyến khích cho các biển có tổng số nút cao mang năng lượng tốt (9 và 10 nút).</p>
                                </div>
                                <div class="text-right flex items-center justify-between sm:justify-end gap-3 flex-shrink-0">
                                    <span class="rounded px-1.5 py-0.5 text-[10px] font-bold {{ $price_prediction['nut_multiplier'] > 1.0 ? 'bg-green-50 border border-green-150 text-green-700' : 'bg-gray-100 border border-gray-200 text-gray-900 font-bold' }}">
                                        x{{ $price_prediction['nut_multiplier'] }}
                                    </span>
                                    <div class="text-[11px] font-bold text-gray-900 whitespace-nowrap">→ {{ $formatMoney($price_prediction['base_price'] * $price_prediction['province_multiplier'] * $price_prediction['nut_multiplier']) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <span class="absolute -left-7 sm:-left-8 top-0.5 transform -translate-x-1/2 flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-white border-2 border-gray-900 text-[10px] sm:text-xs font-black text-gray-900 shadow-sm">4</span>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pl-3">
                                <div>
                                    <h5 class="text-xs sm:text-sm font-bold text-gray-900">Chiết khấu tránh số xấu (Số 4, 7)</h5>
                                    <p class="text-[10px] sm:text-xs text-gray-900 mt-0.5">Khấu trừ giá trị đối với các biển số có chứa chữ số Hán Việt không được ưu chuộng.</p>
                                </div>
                                <div class="text-right flex items-center justify-between sm:justify-end gap-3 flex-shrink-0">
                                    <span class="rounded px-1.5 py-0.5 text-[10px] font-bold {{ $price_prediction['has_bad_numbers'] ? 'bg-red-50 border border-red-150 text-red-700' : 'bg-gray-100 border border-gray-200 text-gray-900 font-bold' }}">
                                        x{{ $price_prediction['bad_multiplier'] }}
                                    </span>
                                    <div class="text-[11px] font-bold text-gray-900 whitespace-nowrap">→ {{ $formatMoney($price_prediction['base_price'] * $price_prediction['province_multiplier'] * $price_prediction['nut_multiplier'] * $price_prediction['bad_multiplier']) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <span class="absolute -left-7 sm:-left-8 top-0.5 transform -translate-x-1/2 flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-full bg-white border-2 border-gray-900 text-[10px] sm:text-xs font-black text-gray-900 shadow-sm">5</span>
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pl-3">
                                <div>
                                    <h5 class="text-xs sm:text-sm font-bold text-gray-900">Hệ số xu hướng biến động sê-ri đuôi "{{ $plate['serial_number'] }}"</h5>
                                    <p class="text-[10px] sm:text-xs text-gray-900 mt-0.5">Tính toán dựa trên chiều biến động giá lịch sử đấu giá của chính các biển số có cùng sê-ri số đuôi này.</p>
                                </div>
                                <div class="text-right flex items-center justify-between sm:justify-end gap-3 flex-shrink-0">
                                    <span class="rounded px-1.5 py-0.5 text-[10px] font-bold {{ $price_prediction['trend']['direction'] === 'up' ? 'bg-green-50 border border-green-150 text-green-700' : ($price_prediction['trend']['direction'] === 'down' ? 'bg-red-50 border border-red-150 text-red-700' : 'bg-gray-100 border border-gray-200 text-gray-900 font-bold') }}">
                                        x{{ $price_prediction['trend']['multiplier'] }}
                                    </span>
                                    <div class="text-[11px] font-bold text-gray-900 whitespace-nowrap">→ {{ $formatMoney($price_prediction['base_price'] * $price_prediction['province_multiplier'] * $price_prediction['nut_multiplier'] * $price_prediction['bad_multiplier'] * $price_prediction['trend']['multiplier']) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-[#8C1E1E]/20 bg-[#8C1E1E]/5 p-5 sm:p-6 text-center mt-8 shadow-inner relative overflow-hidden">
                        ...
                        <div class="relative z-10 text-xs text-gray-900 font-bold">
                            Khoảng ước lượng an toàn: <strong class="text-gray-950">{{ $formatMoney($price_prediction['min']) }}</strong> - <strong class="text-gray-950">{{ $formatMoney($price_prediction['max']) }}</strong>
                        </div>
                        @if($price_prediction['is_completed'])
                            <div class="relative z-10 mt-3 text-[10px] font-bold text-green-700 bg-green-50 border border-green-200 inline-flex items-center gap-1 px-3 py-1 rounded-full">
                ...
                <div class="space-y-6">
                    <h4 class="text-xs sm:text-sm font-bold text-gray-900 uppercase tracking-wider mb-2">Công thức định giá tổng quát</h4>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div class="rounded-xl border border-gray-300 bg-white p-4 sm:p-5 shadow-sm">
                            <div class="flex items-center gap-2 mb-3.5">
                                <span class="text-[10px] font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded uppercase tracking-wider">Mốc 1</span>
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            <div class="rounded-xl border border-gray-300 bg-white p-4 sm:p-5 shadow-sm">
                                <div class="flex items-center gap-2 mb-3.5">
                                    <span class="text-[10px] font-bold text-gray-900 bg-gray-100 px-2 py-0.5 rounded uppercase tracking-wider">Mốc 2</span>
                                    <span class="text-xs sm:text-sm font-bold text-gray-955">Hệ số nhân điều chỉnh</span>
                                </div>
                                <div class="space-y-3.5 text-[11px] sm:text-[13px] leading-relaxed">
                                    ...
                                    <div class="space-y-2 border-b border-gray-100 pb-3">
                                        ...
                                        <p class="text-[10px] text-gray-900 pl-3 font-semibold">Áp dụng khi tổng số nút đạt 9 hoặc 10 nút.</p>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-[10px] text-gray-900 pl-3 font-semibold">Áp dụng khi biển số có chứa chữ số 4 hoặc 7.</p>
                                    </div>
                                </div>
                            </div>

                            <div class="rounded-xl border border-gray-300 bg-white p-4 shadow-sm">
                                <h5 class="text-xs font-bold text-gray-955 uppercase mb-1">* Quy tắc giá sàn & giới hạn</h5>
