...
CẤM TUYỆT ĐỐI các cụm từ sáo rỗng thường thấy của AI như: 'Trong cuộc sống ngày nay', 'Như chúng ta đã biết', 'Đầu tiên/Thứ hai/Hơn thế nữa', 'Tóm lại', 'Tương sinh tương khắc đóng vai trò...', 'Hãy cùng chúng tôi khám phá...'. Vào thẳng vấn đề bài viết với câu mở đầu cuốn hút, độc bản.";
...
{
  \"title\": \"Tiêu đề hấp dẫn, chứa từ khóa '[display_number]', không dập khuôn (Ví dụ: 'Giải mã biển số {$plate->display_number}: Lộc phát trường tồn hay ẩn chứa điềm hung?'), dài 50-70 ký tự\",
...
- Đa dạng hóa các câu mở đầu của từng đoạn. Không dùng các câu nối cứng nhắc của AI.
- Chỉ trả về chuỗi JSON hợp lệ không chứa markdown bao quanh. Không giải thích gì thêm.";
        ...
        try {
            ...
            Log::error('Error generating AI content via Groq for plate ' . $plate->full_number, [
